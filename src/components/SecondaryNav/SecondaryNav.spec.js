...
describe('SecondaryNav', () => {
    ...
    it('should add extra attribute', () => {
        const wrapper = shallow(
            <SecondaryNav data-custom="test" header="my header">
                hello
            </SecondaryNav>
        );
    ...
    it('should have .secondaryNav_hidden when the menu is hidden', () => {
        const wrapper = shallow(
            <SecondaryNav header="my header" isDefaultVisible={false}>
                hello
            </SecondaryNav>
        );
    ...
    it('should set width to zero when the menu is hidden', () => {
        const wrapper = shallow(
            <SecondaryNav isDefaultVisible={false} header="my header">
                hello
            </SecondaryNav>
        );
    ...
    it('should call onToggled when clicking on expand button', () => {
        ...
        const wrapper = shallow(
            <SecondaryNav header="my header" onToggled={clickHandler}>
                hello
            </SecondaryNav>
        );
