...
describe('Separator', () => {
    ...
    it('should display horizontal separator by default', () => {
        const wrapper = shallow(<Separator size="medium" />);
        expect(wrapper.html()).toContain('separator_horizontal');
    });

    it('should display vertical separator', () => {
        const wrapper = shallow(<Separator variant="vertical" size="medium" />);
    ...
    it('should add extra attribute', () => {
        const wrapper = shallow(<Separator data-custom="test" size="medium" />);
        expect(wrapper.html()).toContain('data-custom="test"');
    });

    it('should add addition classname', () => {
        const wrapper = shallow(<Separator className="test" size="medium" />);
    ...
    it('should have the class invisible_lastChild', () => {
        const wrapper = shallow(
            <Separator variant="vertical" size="medium" invisible="lastChild" />
        );
    ...
    it('should have the class invisible_onlyChild', () => {
        const wrapper = shallow(
            <Separator variant="vertical" size="medium" invisible="onlyChild" />
        );
